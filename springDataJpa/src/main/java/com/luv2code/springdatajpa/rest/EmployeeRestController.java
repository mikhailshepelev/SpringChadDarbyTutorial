package com.luv2code.springdatajpa.rest;


import com.luv2code.springdatajpa.entity.Employee;
import com.luv2code.springdatajpa.service.EmployeeService;
...
public class EmployeeRestController {
    ...
    public Employee getEmployee(@PathVariable int employeeId){
        ...
        if (theEmployee == null) throw new RuntimeException("Employee not found - " + employeeId);
        return theEmployee;
    }
